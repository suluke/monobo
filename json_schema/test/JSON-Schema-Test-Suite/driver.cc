...
static std::pair<std::string_view, std::string_view> gDisabledList[] = {
    ...
    {"unevaluatedProperties/unevaluatedPropertieswithoneOf",
     "withunevaluatedproperties"},
    {"ref/refswithrelativeurisanddefs", "invalidoninnerfield"},
    {"ref/refswithrelativeurisanddefs", "invalidonouterfield"},
    {"ref/relativerefswithabsoluteurisanddefs", "invalidoninnerfield"},
    {"ref/relativerefswithabsoluteurisanddefs", "invalidonouterfield"},
    {"refRemote/remoterefwithreftodefs", "invalid"},
    {"unevaluatedProperties/unevaluatedPropertieswithif/then/"
     "else,thennotdefined",
     "whenifistrueandhasnounevaluatedproperties"},
    {"unevaluatedProperties/unevaluatedPropertieswithif/then/"
     "else,thennotdefined",
     "whenifistrueandhasunevaluatedproperties"},
    {"unevaluatedProperties/unevaluatedPropertieswithif/then/"
    ...
    {"unevaluatedProperties/unevaluatedPropertieswithif/then/"
     "else,elsenotdefined",
     "whenifisfalseandhasnounevaluatedproperties"},
    {"unevaluatedProperties/unevaluatedPropertieswithif/then/"
     "else,elsenotdefined",
     "whenifisfalseandhasunevaluatedproperties"},
    {"unevaluatedProperties/unevaluatedProperties+singlecyclicref",
     "Unevaluatedon1stlevelisinvalid"},
    {"unevaluatedProperties/unevaluatedProperties+singlecyclicref",
     "Unevaluatedon2ndlevelisinvalid"},
    {"unevaluatedProperties/unevaluatedProperties+singlecyclicref",
     "Unevaluatedon3rdlevelisinvalid"},
    {"unevaluatedProperties/unevaluatedProperties+refinsideallOf/oneOf",
     "Emptyisinvalid(noxory)"},
    {"unevaluatedProperties/unevaluatedProperties+refinsideallOf/oneOf",
     "aandbareinvalid(noxory)"},
    {"unevaluatedProperties/unevaluatedProperties+refinsideallOf/oneOf",
     "aandyarevalid"},
    {"unevaluatedProperties/unevaluatedProperties+refinsideallOf/oneOf",
     "aandbandyarevalid"},
    {"unevaluatedProperties/dynamicevalationinsidenestedrefs",
     "Emptyisinvalid"},
    {"unevaluatedProperties/dynamicevalationinsidenestedrefs", "aisvalid"},
    {"unevaluatedProperties/dynamicevalationinsidenestedrefs", "b+cisinvalid"},
    {"unevaluatedProperties/dynamicevalationinsidenestedrefs", "b+disinvalid"},
    {"unevaluatedProperties/dynamicevalationinsidenestedrefs", "c+disinvalid"},
    {"unevaluatedProperties/dynamicevalationinsidenestedrefs",
     "xx+fooisinvalid"},
    {"unevaluatedProperties/dynamicevalationinsidenestedrefs", "xx+bisinvalid"},
    {"unevaluatedProperties/dynamicevalationinsidenestedrefs", "xx+cisinvalid"},
    {"unevaluatedProperties/dynamicevalationinsidenestedrefs", "xx+disinvalid"},
    {"recursiveRef/"
     "dynamic$recursiveRefdestination(notpredictableatschemacompiletime)",
     "integernode"},
    {"anchor/same$anchorwithdifferentbaseuri",
     "$refshouldnotresolveto/$defs/A/allOf/0"},
};
