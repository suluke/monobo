...
static std::pair<std::string_view, std::string_view> gDisabledList[] = {
    ...
    {"allOf/allOf", "mismatchfirst"},
    {"allOf/allOf", "mismatchsecond"},
    {"allOf/allOf", "wrongtype"},
    {"allOf/allOfsimpletypes", "mismatchone"},
    {"allOf/allOfwithbaseschema", "mismatchboth"},
    {"allOf/allOfwithbaseschema", "mismatchfirstallOf"},
    {"allOf/allOfwithbaseschema", "mismatchsecondallOf"},
    {"allOf/allOfwithbooleanschemas,allfalse", "anyvalueisinvalid"},
    {"allOf/allOfwithbooleanschemas,somefalse", "anyvalueisinvalid"},
    {"allOf/allOfwiththefirstemptyschema", "stringisinvalid"},
    {"allOf/allOfwiththelastemptyschema", "stringisinvalid"},
